      ...
      <div>
        ...
        >
          ...
          <ExperienceSection title="Process">
            ...
            {' '}
            offered intuitive and versatile components, optimized for web, mobile and desktop that was backed by
            research to establish thorough design principles. These features enabled me to focus on learning Angular
            and
            <span className="Highlight">increase development velocity</span>
            .
            <p className="ExperienceSectionSubTitle">Internationalization</p>
            It became apparent that WhatsApp does not standardize their datetime format. Although there exist functions
            that will attempt to parse a string without a specified format, they do not guarantee that the correct
            format will be found. To mitigate any issue, the user is asked to enter the datetime used in their chat
            with aid from an example from their chat and validation.
            ...
            deleted once processed and the resulting analysis is stored for 72 hours to enable the ability to share
            the analysis. Having cleanup scripts scheduled to run through automated cloud functions helped Whanalysis
            to remain in accordance to privacy law and reduce maintenance.
            <br />
            <br />
            The user is given an access code which they may share with others. This is a justified tradeoff between
            shareability and security. The user is reminded of the security concerns.
            <p className="ExperienceSectionSubTitle">Demo</p>
            People are inpatient; they want to see results fast. With a single click, the user has insight into what
            is available. A demo should ease privacy concerns as the user need not sacrifice any of their privacy to
          ...
          <ExperienceSection title="Review">
            ...
            ; one that was less challenging than anticipated given the higher complexity in comparison to alternatives
            React and
            <a
              className="Highlight"
            ...
            . Being a fully-fledged framework, Angular eliminated the choice of libraries and allowed focus to remain
            on the concepts rather than managerial decisions. With previous experience in type-based programming, the
            mandate to use TypeScript was welcome and offered a familiar experience. Having chosen another
            Google-backed technology, Firebase provided frictionless integration with Angular.
            <br />
            <br />
