            ...
            <div>
                <Experience
                    ...
                    <ExperienceSection title="Process">
                        ...
                        Given that Angular was the chosen framework, Material Design was the obvious choice. <a class="Highlight" href="https://material.angular.io/" target="_blank" rel='noopener noreferrer'>Angular Material</a> offered intuitive and versatile components, optimized for web, mobile and desktop that was backed by research to establish thorough design principles. These features enabled me to focus on learning Angular and <span className='Highlight'>increase development velocity</span>.
                        ...
                        <br />
                        <br />
                        <a class="Highlight" href="https://firebase.google.com/" target="_blank" rel='noopener noreferrer'>Google Firebase</a> recommended security rules to block unauthorized access to data; these were enforced. In <span className='Highlight'>accordance with GDPR</span>, data is retained for the limited time that is deemed necessary. The user submitted chat messages are deleted once processed and the resulting analysis is stored for 72 hours to enable the ability to share the analysis. Having cleanup scripts scheduled to run through automated cloud functions helped Whanalysis to remain in accordance to privacy law and reduce maintenance.
                        <br />
                        <br />
