            ...
            <div>
                <Experience
                    ...
                    <ExperienceSection title="Process">
                        ...
                        <br />
                        <br />
                        Google Firebase recommended security rules to block unauthorized access to data; these were enforced. In <span className='Highlight'>accordance with GDPR</span>, data is retained for the limited time that is deemed necessary. The user submitted chat messages are deleted once processed and the resulting analysis is stored for 72 hours to enable the ability to share the analysis. Having cleanup scripts scheduled to run through automated cloud functions helped Whanalysis to remain in accordance to privacy law and reduce maintenance.
                        <br />
                        <br />
