      ...
      <div>
        ...
        >
          ...
          <div className="ExperienceDescription">
            ...
            users in 150 countries rely on Sophos to provide
          ...
          <ExperienceSection title="Role">
            ...
            My career at Sophos began as a Software Engineer Intern during my university year in industry. I worked
            alongside other software engineers of varying levels from graduate to senior. The team that I was
            assigned to -
            {' '}
            <a
              className="Highlight"
            ...
            to false positives. My initial focus was to accommodate existing customer requirements and develop features
            to
          ...
          <ExperienceSection title="Learnings">
            ...
            Writing predominantly in C++ allowed me to consolidate my understanding of object orientated programming
            concepts which can be translated across many languages.
            <br />
            <br />
            ...
            , low level driver features highlighted the importance of writing high quality code with thorough error
            handling to accommodate edge cases that could result in critical failure. This further enforced the
